...
$link_item = "http://allaclone.p2002.com/item.php?id={ITEM_ID}";

//a link to a spell using the spell id 
//{SPELL_ID} - The ID of the spell
$link_spell = "http://allaclone.p2002.com/spell.php?id={SPELL_ID}";

//a link to a zone using a shortname or id 
//{ZONE_SHORTNAME} - The shortname of the zone
//{ZONE_ID} - The ID of the zone
$link_zone = "http://allaclone.p2002.com/zone.php?name={ZONE_SHORTNAME}";
...
$link_map = "http://allaclone.p2002.com/zone.php?name={ZONE_SHORTNAME}";

//a link to information about a faction using the faction id.
//{FACTION_ID} - The ID of the faction group
$link_faction = "http://allaclone.p2002.com/faction.php?id={FACTION_ID}";
/**************************************************************************************************/
